...
(function($, window, document, undefined) {
    ...
    Timepicker.prototype = {
        ...
        /***** 내입맛에 맞게 수정!!! start *****/
        setdecrementhourrange : function(stTime,edTime){
        	if (this.showMeridian) {
                if (this.hour === 1) {
                    this.hour = 12;
                } else if (this.hour === 12 && this.meridian=='PM') {
                    this.hour--;
                    return this.meridian='AM';
                } else if (this.hour <= stTime && this.meridian=='AM') {
                    this.hour = edTime;
        ...
        decrementHour: function() {
    		...
    		if(this.day.toUpperCase()=='SAT' || this.day.toUpperCase()=='SUN'){
    			...
    			this.setdecrementhourrange(this.weekdaystTime,this.weekdayedTime);
    		}
        ...
        /***** 내입맛에 맞게 수정!!! start *****/
        setincrementhourrange : function(stTime,edTime){
        	if (this.showMeridian) {
                if (this.hour === 12) {
                    this.hour = 1;
                } else if (this.hour === 11 && this.meridian=='AM') {
                    this.hour++;
                    return this.meridian='PM';
                } else if (this.hour >= edTime && this.meridian=='PM') {
                    this.hour = stTime;
                    return this.meridian='AM';
                }else {
                    this.hour++;
        ...
        incrementHour: function() {
    		...
    		if(this.day.toUpperCase()=='SAT' || this.day.toUpperCase()=='SUN'){
    			...
    			this.setincrementhourrange(this.weekdaystTime,this.weekdayedTime);
    		}
        ...
        toggleMeridian: function() {
        	...
        	if(this.day.toUpperCase()=='SAT' || this.day.toUpperCase()=='SUN'){
    			if(this.hour < this.weekendstTime && this.meridian=='PM'){
    				this.hour = this.weekendstTime;
    				this.meridian = 'AM';
    			}else if(this.hour > this.weekendedTime && this.meridian=='AM'){
    				this.hour = this.weekendedTime;
    				this.meridian = 'PM';
    			}
        	}else{
        		if(this.hour < this.weekdaystTime && this.meridian=='PM'){
    				this.hour = this.weekdaystTime;
    				this.meridian = 'AM';
    			}else if(this.hour > this.weekdayedTime && this.meridian=='AM'){
    				this.hour = this.weekdayedTime;
    				this.meridian = 'PM';
    			}
        	}
