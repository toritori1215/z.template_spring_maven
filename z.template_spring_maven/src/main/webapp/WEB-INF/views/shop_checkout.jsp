							...
							<ul class="orders-table">
								...
								<li class="clearfix">
									<div class="col" style="text-transform:none;">
										<img src="${pageContext.request.contextPath}/resources/img/products/thumb-1.jpg" width="50" height="50" alt=""> World Travel Guide
									</div>
								...
								<ul>
									...
									<li>
										<div class="radio-option">
											...
											<label for="payment-3">Paypal<img src="${pageContext.request.contextPath}/resources/img/credit-card-icon.png" alt="">
											</label>
										</div>
									</li>
								</ul>
