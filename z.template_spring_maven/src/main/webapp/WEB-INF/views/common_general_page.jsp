		...
		<div class="container margin_60">
			...
			<div class="row justify-content-between">
				<div class="col-lg-4 col-md-5">
					<img src="${pageContext.request.contextPath}/resources/img/tour_box_13.jpg" alt="Image" class="img-fluid styled">
				</div>
			...
			<div class="row justify-content-between">
				<div class="col-lg-4 col-md-5">
					<img src="${pageContext.request.contextPath}/resources/img/tour_box_11.jpg" alt="Image" class="img-fluid styled">
				</div>
				<div class="col-lg-7 col-md-7">
			...
			<div class="row justify-content-between">
				<div class="col-lg-4 col-md-5 text-center">
					<img src="${pageContext.request.contextPath}/resources/img/bag.png" alt="Image">
				</div>
				<div class="col-lg-7 col-md-7">
