...
public class RestaurantBoardListPageDto {
	private List<RestaurantDTO> list; 		// 리스트 데이터 콜렉션
	...
	public RestaurantBoardListPageDto() {
	}

	public RestaurantBoardListPageDto(List<RestaurantDTO> list, int startPageNo, int endPageNo,
	...
	public String toString() {
		return "RestaurantBoardListPageDto [list=" + list + ", startPageNo=" + startPageNo + ", endPageNo=" + endPageNo
